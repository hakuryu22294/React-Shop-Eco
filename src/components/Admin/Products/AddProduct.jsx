...
import { getCategoryAction } from "../../../redux/slices/categories/categorySlices";
import { getBrandsAction } from "../../../redux/slices/brand/brandSlices";
import { getColors } from "../../../redux/slices/colors/colorSlices";
  ...
  const fileHandleChange = (e) => {
    ...
    newFiles.forEach((file) => {
      ...
      if (!file?.type?.startWith("image/")) {
        newErrs.push(`${file.name} is not an image file`);
      }
    });
    setFiles(newFiles);
    setFileErrs(newErrs);
